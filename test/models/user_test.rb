...
class UserTest < ActiveSupport::TestCase
  ...
  test "email should be present" do 
  	@user.email = "    "
  	assert_not @user.valid?, "#{@user.email} is a blank email address"
  end
  ...
  test "email validation sould reject invalid addresses" do 
  	invalid_addresses = %w[user@example,com user_at_foo.org user.name@example.foo@bar_baz.com foo@bar+baz.com, bob..bob@wrong.com, bob.bob@wrong..com]
